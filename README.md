About colicoords-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colicoords-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Jhsmit/ColiCoords
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2285&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colicoords-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colicoords` can be installed with `conda`:
...
```
mamba install colicoords
```

It is possible to list all of the versions of `colicoords` available on your platform with `conda`:
...
```
mamba search colicoords --channel conda-forge
```
...
mamba repoquery search colicoords --channel conda-forge

# List packages depending on `colicoords`:
mamba repoquery whoneeds colicoords --channel conda-forge

# List dependencies of `colicoords`:
mamba repoquery depends colicoords --channel conda-forge
```
